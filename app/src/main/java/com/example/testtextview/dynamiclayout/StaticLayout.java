...
import com.example.testtextview.dynamiclayout.Layout.SpannedEllipsizer;
import com.example.testtextview.dynamiclayout.Layout.Ellipsizer;

import com.example.testtextview.dynamiclayout.Layout.BreakStrategy;
import com.example.testtextview.dynamiclayout.Layout.HyphenationFrequency;
import com.example.testtextview.dynamiclayout.Layout.JustificationMode;
...
public class StaticLayout extends Layout {
    ...
    public final static class Builder {
         ...
         */
        public Builder setBreakStrategy(@com.example.testtextview.dynamiclayout.Layout.BreakStrategy int breakStrategy) {
         ...
         */
        public Builder setHyphenationFrequency(@com.example.testtextview.dynamiclayout.Layout.HyphenationFrequency int hyphenationFrequency) {
         ...
         * @return this builder, useful for chaining.
         */
        public Builder setJustificationMode(@com.example.testtextview.dynamiclayout.Layout.JustificationMode int justificationMode) {
...
//        }
    ...
    public StaticLayout(CharSequence source, int bufstart, int bufend,
        ...
        mLineDirections = ArrayUtils.newUnpaddedArray2(Directions.class, 2 * mColumns);
...
//                    measured.addStyleRun(paint, spans, spanLen, fm);
    ...
    private int out(CharSequence text, int start, int end,
        ...
        if (want >= lines.length) {
            Directions[] grow2 = ArrayUtils.newUnpaddedArray2(
