...
//         */
//        public static android.text.StaticLayout.Builder obtain(CharSequence source, int start, int end, TextPaint paint,
//                                                               int width) {
//            android.text.StaticLayout.Builder b = sPool.acquire();
//            if (b == null) {
...
//            b.mJustificationMode = android.text.Layout.JUSTIFICATION_MODE_NONE;
//
...
//        }
//
//        public android.text.StaticLayout.Builder setText(CharSequence source) {
...
//         * of normal {@link android.text.StaticLayout} usage.
//         *
//         * @param source The text to be laid out, optionally with spans
//         * @param start The index of the start of the text
//         * @param end The index + 1 of the end of the text
...
//         * @hide
//         */
//        public android.text.StaticLayout.Builder setText(CharSequence source, int start, int end) {
//            mText = source;
//            mStart = start;
//            mEnd = end;
//            return this;
...
//         * @hide
//         */
//        public android.text.StaticLayout.Builder setPaint(TextPaint paint) {
//            mPaint = paint;
//            return this;
//        }
//
...
//
//        /**
//         * Set the alignment. The default is {@link android.text.Layout.Alignment#ALIGN_NORMAL}.
//         *
//         * @param alignment Alignment for the resulting {@link android.text.StaticLayout}
//         * @return this builder, useful for chaining
//         */
//        public android.text.StaticLayout.Builder setAlignment(Alignment alignment) {
...
//         * @return this builder, useful for chaining
//         */
//        public android.text.StaticLayout.Builder setTextDirection(TextDirectionHeuristic textDir) {
//            mTextDir = textDir;
//            return this;
//        }
//
...
//         * @see android.widget.TextView#setEllipsize
//         */
//        public android.text.StaticLayout.Builder setEllipsize(@Nullable TextUtils.TruncateAt ellipsize) {
...
//         * layout options. The default is {@link android.text.Layout#BREAK_STRATEGY_SIMPLE}.
//         *
//         * @param breakStrategy break strategy for paragraph layout
//         * @return this builder, useful for chaining
//         * @see android.widget.TextView#setBreakStrategy
//         */
//        public android.text.StaticLayout.Builder setBreakStrategy(@BreakStrategy int breakStrategy) {
...
//         * default is {@link android.text.Layout#HYPHENATION_FREQUENCY_NONE}.
//         *
//         * @param hyphenationFrequency hyphenation frequency for the paragraph
//         * @return this builder, useful for chaining
//         * @see android.widget.TextView#setHyphenationFrequency
//         */
//        public android.text.StaticLayout.Builder setHyphenationFrequency(@HyphenationFrequency int hyphenationFrequency) {
...
//         * {@link android.text.Layout#JUSTIFICATION_MODE_NONE}. If the last line is too short for justification,
...
//         * @return this builder, useful for chaining.
//         */
//        public android.text.StaticLayout.Builder setJustificationMode(@JustificationMode int justificationMode) {
...
//
//        /**
//         * Build the {@link android.text.StaticLayout} after options have been set.
//         *
...
//         *
//         * @return the newly constructed {@link android.text.StaticLayout} object
//         */
...
//        Locale mLocale;
//
//        private static final SynchronizedPool<android.text.StaticLayout.Builder> sPool = new SynchronizedPool<android.text.StaticLayout.Builder>(3);
//    }
//
...
//
//        android.text.StaticLayout.Builder b = android.text.StaticLayout.Builder.obtain(source, bufstart, bufend, paint, outerwidth)
//                .setAlignment(align)
...
//    }
//
//    /* package */ void generate(android.text.StaticLayout.Builder b, boolean includepad, boolean trackpad) {
...
//
//            if (spanned != null) {
//                android.text.style.LeadingMarginSpan[] sp = getParagraphSpans(spanned, paraStart, paraEnd,
