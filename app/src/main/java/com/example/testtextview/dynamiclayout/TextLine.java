...
import com.example.testtextview.dynamiclayout.Layout.Directions;
import com.example.testtextview.dynamiclayout.Layout.TabStops;
...
//        wp.setWordSpacing(mAddedWidth);
        ...
        if (mSpanned == null) {
            ...
            spans = ArrayUtils.removeEmptySpans(spans, mSpanned, MetricAffectingSpan.class);
