...
//
//        shadowView.setTextAppearance(android.R.styleable.Theme_textAppearanceLarge);
//        shadowView.setGravity(Gravity.CENTER);
//
//        shadowView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
