...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public static boolean hasRtlSupport(ApplicationInfo info) {
        return (info.flags & ApplicationInfo.FLAG_SUPPORTS_RTL) == ApplicationInfo.FLAG_SUPPORTS_RTL;
    }
    ...
    static class Drawables {
        ...
        public Drawables(Context context) {
            ...
            mIsRtlCompatibilityMode = targetSdkVersion < Build.VERSION_CODES.JELLY_BEAN_MR1
                    || !hasRtlSupport(context.getApplicationInfo());
            mOverride = false;
        }
...
//                        }
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.TextView_drawableTint:
                    drawableTint = a.getColorStateList(attr);
                    break;

//                case R.styleable.TextView_drawableTintMode:
...
//                    }
                ...
                case R.styleable.TextView_allowUndo:
...
//                            mEditor.mInputContentType.imeActionId);
                ...
                case R.styleable.TextView_textEditSuggestionContainerLayout:
                    mTextEditSuggestionContainerLayout = a.getResourceId(attr, 0);
                    break;

                case R.styleable.TextView_textEditSuggestionHighlightStyle:
...
//                case R.styleable.TextView_autoSizeTextType:
//                    mAutoSizeTextType = a.getInt(attr, AUTO_SIZE_TEXT_TYPE_NONE);
//                    break;

                case R.styleable.TextView_autoSizeStepGranularity:
                    autoSizeStepGranularityInPx = a.getDimension(attr,
                            UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
                    break;

                case R.styleable.TextView_autoSizeMinTextSize:
                    autoSizeMinTextSizeInPx = a.getDimension(attr,
                            UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
                    break;

                case R.styleable.TextView_autoSizeMaxTextSize:
                    autoSizeMaxTextSizeInPx = a.getDimension(attr,
                            UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
                    break;

                case R.styleable.TextView_autoSizePresetSizes:
...
//        if (mEditor != null) mEditor.prepareCursorControllers();
     ...
     *
     * @attr ref R.styleable#TextView_autoSizeTextType
     *
     ...
     *
     * @attr ref R.styleable#TextView_autoSizeTextType
     * @attr ref R.styleable#TextView_autoSizeMinTextSize
     * @attr ref R.styleable#TextView_autoSizeMaxTextSize
     * @attr ref R.styleable#TextView_autoSizeStepGranularity
     *
     ...
     *
     * @attr ref R.styleable#TextView_autoSizeTextType
     * @attr ref R.styleable#TextView_autoSizePresetSizes
     *
     * @see #setAutoSizeTextTypeWithDefaults(int)
...
//        }
     ...
     *
     * @attr ref R.styleable#TextView_typeface
     * @attr ref R.styleable#TextView_textStyle
     */
     ...
     * with an argument of { TextView.BufferType#SPANNABLE BufferType.SPANNABLE}
     * or { TextView.BufferType#EDITABLE BufferType.EDITABLE}, you can cast
     ...
     * @attr ref R.styleable#TextView_text
     */
    ...
    /**
     * @return the { android.text.Layout} that is currently being used to
    ...
    /**
     * Retrieve the { android.content.UndoManager} that is currently associated
     ...
     * { #setUndoManager(android.content.UndoManager, String)}
     *
     * @hide
     */
...
//    }
    ...
    /**
     * Associate an { android.content.UndoManager} with this TextView.  Once
     ...
     * stack.
     *
     * @param undoManager The { android.content.UndoManager} to associate with
...
//    }
     ...
     *
     * @attr ref R.styleable#TextView_numeric
     * @attr ref R.styleable#TextView_digits
     * @attr ref R.styleable#TextView_phoneNumber
     * @attr ref R.styleable#TextView_inputMethod
     * @attr ref R.styleable#TextView_capitalize
     * @attr ref R.styleable#TextView_autoText
     */
...
//        return mEditor == null ? null : mEditor.mKeyListener;
     ...
     * see { KeyListener#getInputType() KeyListener.getContentType()}
...
//            if (mEditor != null) mEditor.prepareCursorControllers();
     ...
     *
     * @attr ref R.styleable#TextView_password
     * @attr ref R.styleable#TextView_singleLine
     */
...
//        resolveDrawables();
     ...
     *
     * @attr ref R.styleable#TextView_drawableLeft
     * @attr ref R.styleable#TextView_drawableTop
     * @attr ref R.styleable#TextView_drawableRight
     * @attr ref R.styleable#TextView_drawableBottom
     */
...
//        resolveDrawables();
     ...
     *
     * @attr ref R.styleable#TextView_drawableStart
     * @attr ref R.styleable#TextView_drawableTop
     * @attr ref R.styleable#TextView_drawableEnd
     * @attr ref R.styleable#TextView_drawableBottom
     */
...
//        resolveDrawables();
     ...
     * the text.
     *
     * @attr ref R.styleable#TextView_drawablePadding
     */
     ...
     *
     * @attr ref R.styleable#TextView_drawableTint
     ...
     * @attr ref R.styleable#TextView_drawableTintMode
     * @see #setCompoundDrawableTintList(ColorStateList)
     ...
     * possible values.
     *
     * @attr ref R.styleable#TextView_autoLink
     */
     ...
     * { R.style#TextAppearance_Material_Body1 @android:style/TextAppearance.Material.Body1}
     * or see { R.styleable#TextAppearance TextAppearance} for the
     * set of attributes that can be used in a custom style.
     *
     * @param resId the resource identifier of the style to apply
     * @attr ref R.styleable#TextView_textAppearance
     */
    @SuppressWarnings("deprecation")
...
//        }
     ...
     *
     * @attr ref R.styleable#TextView_textSize
     */
     ...
     * @attr ref R.styleable#TextView_textScaleX
     */
     ...
     * @see #getTypeface()
     *
     * @attr ref R.styleable#TextView_fontFamily
     * @attr ref R.styleable#TextView_typeface
     * @attr ref R.styleable#TextView_textStyle
     */
     ...
     *
     * @attr ref R.styleable#TextView_elegantTextHeight
     */
     ...
     * @attr ref R.styleable#TextView_letterSpacing
     */
     ...
     *
     * @attr ref R.styleable#TextView_breakStrategy
     ...
     * @attr ref R.styleable#TextView_hyphenationFrequency
     ...
     *
     * @attr ref R.styleable#TextView_fontFeatureSettings
     */
...
//    }
     ...
     * @see #getTextColors()
     *
     * @attr ref R.styleable#TextView_textColor
     */
     ...
     *
     * @attr ref R.styleable#TextView_textColorHighlight
     */
...
//    }
     ...
     *
     * @attr ref R.styleable#TextView_shadowColor
     * @attr ref R.styleable#TextView_shadowDx
     * @attr ref R.styleable#TextView_shadowDy
     * @attr ref R.styleable#TextView_shadowRadius
     */
...
//        }
     ...
     * The default is true.
     *
     * @attr ref R.styleable#TextView_linksClickable
     */
     ...
     * @see #setTextColor(int)
     *
     * @attr ref R.styleable#TextView_textColorHint
     */
     ...
     *
     * @attr ref R.styleable#TextView_textColorLink
     */
     ...
     * @attr ref R.styleable#TextView_gravity
     */
     ...
     *
     * @attr ref R.styleable#TextView_scrollHorizontally
     */
     ...
     * @see #setLines(int)
     *
     * @attr ref R.styleable#TextView_minLines
     */
     ...
     * @see #setHeight(int)
     *
     * @attr ref R.styleable#TextView_minHeight
     */
     ...
     * @see #setLines(int)
     *
     * @attr ref R.styleable#TextView_maxLines
     */
     ...
     * @see #setHeight(int)
     *
     * @attr ref R.styleable#TextView_maxHeight
     */
     ...
     * @see #setHeight(int)
     *
     * @attr ref R.styleable#TextView_lines
     */
     ...
     * @see #setLines(int)
     *
     * @attr ref R.styleable#TextView_height
     */
     ...
     * @see #setEms(int)
     *
     * @attr ref R.styleable#TextView_minEms
     */
     ...
     * @see #setWidth(int)
     *
     * @attr ref R.styleable#TextView_minWidth
     */
     ...
     * @see #setEms(int)
     *
     * @attr ref R.styleable#TextView_maxEms
     */
     ...
     * @see #setWidth(int)
     *
     * @attr ref R.styleable#TextView_maxWidth
     */
     ...
     * @see #setWidth(int)
     *
     * @attr ref R.styleable#TextView_ems
     */
     ...
     * @see #setEms(int)
     *
     * @attr ref R.styleable#TextView_width
     */
     ...
     *
     * @attr ref R.styleable#TextView_lineSpacingExtra
     * @attr ref R.styleable#TextView_lineSpacingMultiplier
     */
     ...
     * display buffer, upgrading it to { TextView.BufferType#EDITABLE}
...
//            mEditor.restoreInstanceState(ss.editorState);
     ...
     *
     * @attr ref R.styleable#TextView_freezesText
     */
     ...
     * @see TextView.BufferType#EDITABLE
     */
     ...
     * @see TextView.BufferType#SPANNABLE
     */
     ...
     *
     * @param text text to be displayed
     * @param type a { TextView.BufferType} which defines whether the text is
     ...
     *
     * @attr ref R.styleable#TextView_text
     * @attr ref R.styleable#TextView_bufferType
     */
...
//        if (mEditor != null) mEditor.prepareCursorControllers();
    ...
    /**
     * Sets the text to be displayed and the { TextView.BufferType} but retains
     * the cursor position. Same as
     * { #setText(CharSequence, TextView.BufferType)} except that the cursor
     ...
     * @attr ref R.styleable#TextView_bufferType
     */
    public final void setText(@StringRes int resid, TextView.BufferType type) {
     ...
     *
     * @attr ref R.styleable#TextView_hint
     */
...
//        }
     ...
     * @attr ref R.styleable#TextView_inputType
     */
...
//        return mEditor == null ? EditorInfo.TYPE_NULL : mEditor.mInputType;
     ...
     * @attr ref R.styleable#TextView_imeOptions
     */
...
//                ? mEditor.mInputContentType.imeOptions : EditorInfo.IME_NULL;
     ...
     * @see #getImeActionId
     * @see android.view.inputmethod.EditorInfo
     * @attr ref R.styleable#TextView_imeActionLabel
     * @attr ref R.styleable#TextView_imeActionId
     */
...
//    }
     ...
     * @attr ref R.styleable#TextView_privateImeOptions
     */
...
//                ? mEditor.mInputContentType.privateImeOptions : null;
     ...
     * { R.styleable#InputExtras &lt;input-extras&gt;} XML tree.
     *
     * @see 
     * @see EditorInfo#extras
     * @attr ref R.styleable#TextView_editorExtras
     */
...
//    }
     ...
     * call { InputMethodManager#restartInput(View)}.</p>
...
//    }
     ...
     *
     * @attr ref R.styleable#TextView_maxLength
     */
...
//        if (mEditor != null) mEditor.onScreenStateChanged(screenState);
     ...
     *
     * @attr ref R.styleable#TextView_textIsSelectable
     */
...
//        return mEditor == null ? false : mEditor.mTextIsSelectable;
     ...
     * { R.styleable#TextView_textIsSelectable} to "true".
     * <p>
     ...
     * { R.styleable#View_focusable android:focusable},
     * { R.styleable#View_focusableInTouchMode android:focusableInTouchMode},
     * { R.styleable#View_clickable android:clickable}, and
     * { R.styleable#View_longClickable android:longClickable}. To restore any of these
...
//                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dr != null) {
            ...
            if (dr.mShowing[Drawables.RIGHT] != null) {
                canvas.save();
                canvas.translate(scrollX + right - left - getPaddingRight()
            ...
            if (dr.mShowing[Drawables.TOP] != null) {
                ...
                canvas.translate(scrollX + compoundPaddingLeft
                        + (hspace - dr.mDrawableWidthTop) / 2, scrollY + getPaddingTop());
...
//        }
    ...
    /**
     * Resets the mErrorWasChanged flag, so that future calls to { #setError(CharSequence)}
     * can be recorded.
     * @hide
     */
...
//        if (mEditor != null) mEditor.prepareCursorControllers();
     ...
     *
     * @attr ref R.styleable#TextView_includeFontPadding
     */
            ...
            if (boring == null || boring == UNKNOWN_BORING) {
                if (des < 0) {
                    des = (int) Math.ceil(Layout.getDesiredWidth(mTransformed, 0,
                            mTransformed.length(), mTextPaint));
                }
                width = des;
            } else {
                width = boring.width;
...
//    }
     ...
     * @attr ref R.styleable#TextView_textAllCaps
     */
...
//        }
     ...
     *
     * @attr ref R.styleable#TextView_ellipsize
     */
     ...
     *
     * @attr ref R.styleable#TextView_marqueeRepeatLimit
     */
     ...
     * selected.
     *
     * @attr ref R.styleable#TextView_selectAllOnFocus
     */
...
//    }
     ...
     *
     *
     * @attr ref R.styleable#TextView_cursorVisible
     */
...
//        }
    ...
    /**
     * Use { BaseInputConnection#removeComposingSpans
...
//        if (mEditor != null) mEditor.mIgnoreActionUpEvent = true;
    ...
    protected float getLeftFadingEdgeStrength() {
        if (isMarqueeFadeEnabled() && mMarquee != null && !mMarquee.isStopped()) {
            ...
            if (lineLeft > getScrollX()) return 0.0f;
    ...
    protected float getRightFadingEdgeStrength() {
        if (isMarqueeFadeEnabled() && mMarquee != null && !mMarquee.isStopped()) {
            ...
            final float rightEdge = getScrollX() +
     ...
     * horizontal positions to { View#getHorizontalFadingEdgeLength()}. Uses the absolute
...
//    }
    ...
    /**
     * Unlike { #textCanBeSelected()}, this method is based on the <i>current</i> state of the
     * TextView. { #textCanBeSelected()} has to be true (this is one of the conditions to have
     * a selection controller (see { Editor#prepareCursorControllers()}), but this is not
     * sufficient.
     */
...
//                        mapRectFromViewToScreenCoords(bounds, true);
    ...
    /**
     * Populate requested character bounds in a { CursorAnchorInfo.Builder}
     *
...
//    static final int ID_AUTOFILL = R.id.autofill;
     ...
     * this will be one of { R.id#selectAll}, { R.id#cut},
     * { R.id#copy}, { R.id#paste} or { R.id#shareText}.
     *
...
//                || variation == EditorInfo.TYPE_TEXT_VARIATION_WEB_EDIT_TEXT);
     ...
     * { android.view.Menu#removeItem(int)} and passing { R.id#selectAll},
     * { R.id#cut}, { R.id#copy}, { R.id#paste},
     * { R.id#replaceText} or { R.id#shareText} ids as parameters.
     *
...
//    }
     ...
     * { android.view.Menu#removeItem(int)} and passing { R.id#selectAll},
     * { R.id#paste} or { R.id#replaceText} ids as parameters.</p>
     *
     * <p>Returning false from
     ...
     * { R.attr#selectAllOnFocus} flag has been set.</p>
     */
